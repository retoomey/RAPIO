...
public:
  ...
  double getTempC() const { return _TempC; };
  double getDewPointC() const { return _DewPointC; };
  double getUWind() const { return _UWind; };
  double getVWind() const { return _VWind; }
  double getPressure() const { return _Pres; }
  double getHeight() const { return _Height; }
  double getSaturationVaporPressure() const { return _SaturationVaporPressure; }
  double getVaporPressure() const { return _VaporPressure; }
  double getLCLTemp() const { return _LCLTemp; }
  double getLCLPres() const { return _LCLPres; }
  double getTempK() const { return _TempK; }
  double getTheta() const { return _Theta; }
  double getThetaE() const { return _ThetaE; }
  double getVirtualTempK() const { return _VirtualTempK; }
  double getVirtualTempC() const { return (_VirtualTempK-273.15); }
  double getMixingRatio() const { return _MixingRatio; }
  double getVerticalVelocity() const { return _VerticalVelocity; }
  double getDewPointDepression();
  double getWetBulbTempK() const {return _WetBulbTempK; }
  double getWetBulbTempC() const {return (_WetBulbTempK - 273.16); }
  ...
  // get RH
  double getRH() const { return _RH; }
  // get RHice
  double getRHice() const { return _RHice; }
...
private:
   ...
   */
  void calculatePointValues();

  // saturation vapor pressure (mb)
  double calcSaturationVaporPressure();
  // saturation vapor pressure over ice (mb)
  double calcSaturationVaporPressureOverIce();
  // vapor pressure (mb)
  double calcVaporPressure();
  // vapor pressure (mb)
  double calcVaporPressure( double t );
  // dew point (C)
  double calcDewPointFromRH();
  // temperature of lifting condensation level
  double calcLCLTemp();
  // pressure at the LCL
  double calcLCLPres();
  // Potential Temperature
  double calcPotentialTemperature();
  // Mixing Ratio
  double calcMixingRatio();
  // Virtual Temperature
  double calcVirtualTemperature();
  // Equivalent Potential Temperature
  double calcEquivalentPotentialTemperature();
