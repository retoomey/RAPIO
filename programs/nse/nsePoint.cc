...
double
nsePoint::getDewPointDepression()
{
  if ((_TempC != Constants::MissingData) &&
    (_DewPointC != Constants::MissingData) )
  {
...
double
nsePoint::calcSaturationVaporPressure()
{
...
double
nsePoint::calcSaturationVaporPressureOverIce()
{
  double ret_val = Constants::MissingData;
...
double
nsePoint::calcVaporPressure(double t)
{
  double ret_val = Constants::MissingData;
...
double
nsePoint::calcTemperatureFromVaporPressure(double VaporPressure)
{
...
double
nsePoint::calcTemperatureFromTheta(double theta, double pres)
{
...
double
nsePoint::calcDewpointFromRH(double temp, double rh)
{
...
double
nsePoint::calcVaporPressure(double MixingRatio, double Pressure)
{
...
double
nsePoint::calcPotentialTemperature()
{
  double ret_val = Constants::MissingData;
...
double
nsePoint::calcVirtualTemperature()
{
  double ret_val = Constants::MissingData;
...
double
nsePoint::calcEquivalentPotentialTemperature()
{
  ...
  if (_MixingRatio < 0.1) { Wtemp = 0; } else { Wtemp = _MixingRatio; }
...
double
nsePoint::speedFromUV(double u, double v)
{
  double speed;
...
void
nsePoint::SpeedDirFromUV(float& u, float& v, float& speed, float& dir)
{
  if ((u == Constants::MissingData) || (v == Constants::MissingData)) {
    speed = Constants::MissingData;
...
double
nsePoint::calcDensity(double pres, double tempK)
{
