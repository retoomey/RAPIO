...
{
  o.setDescription("rNSE reads data from a 3D model file (pressure coordinates) and make several computations of paramenters similar to SPC SFCOA mesoanalysis.");
