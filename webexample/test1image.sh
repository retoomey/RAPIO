...
../../bin/rtile -i file=19990503-235123.netcdf.gz --zoom=7 --image-height=1024 --image-width=1024 --center-latitude=35.333  --center-longitude=-97.278 -o file=output1.png --verbose=info  --flags=box
