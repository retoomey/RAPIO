...
function(find_third_party the_package)
  ...
  if (${the_package}_FOUND)
    ...
    set(${the_package}_FOUND TRUE PARENT_SCOPE)
    ...
    # Set to empty so cmake doesn't whine on smart conditional subcmakes
    set(${the_package}_LIBRARIES "" PARENT_SCOPE)
    set(${the_package}_INCLUDE_DIR "" PARENT_SCOPE)
  endif()
endfunction()
