...
namespace cron
{
   ...
   namespace utils
   {
      ...
      inline std::tm to_tm(CRONCPP_STRING_VIEW time)
      {
         ...
         int minute = 0;
         int second = 0;
         // Toomey May 2026. patch
         // Our compiler is new enough this is dead code anyway, but semgrep doesn't know that
         // and I want to do the minimum patch here, so we'll use nosemgrep
         // nosemgrep
